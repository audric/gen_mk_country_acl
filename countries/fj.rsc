...
# Allow and count:
# /ip firewall filter
# add action=accept chain=input src-address-list="FJ country" comment="Allow FJ traffic"
# 
# Block and count:
# /ip firewall filter
# add action=drop chain=input src-address-list="FJ country" comment="Block FJ traffic"
