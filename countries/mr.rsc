...
# Allow and count:
# /ip firewall filter
# add action=accept chain=input src-address-list="MR country" comment="Allow MR traffic"
# 
# Block and count:
# /ip firewall filter
# add action=drop chain=input src-address-list="MR country" comment="Block MR traffic"
